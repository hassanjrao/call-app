    ...
    <div class="container office">
        <div class="hero-container">
            ...
            <div class="hero__desc">
                <p>
                    Renovate and assess the efficiency of your existing marketing policy with HivoCall bespoke Call Analytics feature. Track records on call volume, call duration, routing of incoming and outbound calls all with the click of a button! <a href="/checkout/{{ $firstPlanId }}">Get A Plan</a>.
